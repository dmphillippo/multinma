...
#'   For a study reporting only two outcomes, say 50 and 90, the counts
#'   represent 50 < PASI < 90 and 90 < PASI < 100. For a study reporting only
#'   one outcome, say PASI 70, the count represents 70 < PASI < 100.
#'
#' @references
#'   \insertAllCited{}
#'
