...
> Dias, S. et al. (2011). "NICE DSU Technical Support Documents 1-7: Evidence Synthesis for Decision Making." _National Institute for Health and Care Excellence._ Available from https://sheffield.ac.uk/nice-dsu/tsds.
...
> Phillippo, D. M. et al. (2026). "Multilevel network meta-regression for general likelihoods: synthesis of individual and aggregate data with applications to survival analysis". _Journal of the Royal Statistical Society: Series A (Statistics in Society)_, 189(3):1856-1875. doi: [10.1093/jrsssa/qnaf169](https://doi.org/10.1093/jrsssa/qnaf169).
