...
af_4b_beta[ , , 1:2] <- sweep(af_4b_beta[ , , 1:2], 1:2, af_4b_beta[ , , "beta[Control:stroke]"], FUN = "-")

# Set beta[Mixed:stroke] = -beta[Control:stroke]
af_4b_beta[ , , "beta[Control:stroke]"] <- -af_4b_beta[ , , "beta[Control:stroke]"]
dimnames(af_4b_beta)[[3]][3] <- "beta[Mixed:stroke]"
