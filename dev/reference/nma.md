...
#> 
#> Samples were drawn using NUTS(diag_e) at Sat Dec 13 11:32:31 2025.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sat Dec 13 11:32:40 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
...
#> tau                                                 1.50  1005    1
#> 
#> Samples were drawn using NUTS(diag_e) at Sat Dec 13 11:33:13 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sat Dec 13 11:35:30 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
...
#> 
#> Samples were drawn using NUTS(diag_e) at Sat Dec 13 11:39:08 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
# }
