...
vignette: >
  %\VignetteIndexEntry{Example: Thrombolytic Treatments}
...
The number of deaths in 30 or 35 days following accute myocardial infarction are recorded.
...
```{r thrombo_tests, include=FALSE, eval=testthat::is_testing()}
