...
[`nma()`](https://dmphillippo.github.io/multinma/reference/nma.md). The
typical convergence rate of Quasi-Monte Carlo integration (as used here)
is \\1/N\\, which by default is displayed on the plot output.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Tue Apr 14 08:16:37 2026.
