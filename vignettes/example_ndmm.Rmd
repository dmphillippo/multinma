...
@Phillippo_surv analysed these data using multilevel network meta-regression (ML-NMR), and we recreate these analyses here.
...
```{r marginal-hazards, fig.height=6}
...
```{r baseline-hazards, fig.height=6}
