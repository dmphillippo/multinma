...
#' individual patient data from three studies (UNCOVER-1, -2, and -3) and
#' aggregate data from one study (FIXTURE), respectively. Outcomes are binary
#' success/failure to achieve 75% reduction in symptoms on the Psoriasis Area
#' and Severity Index (PASI) scale.
#'
