...
Also, add in a `trtclass` variable, indicating which treatments belong to which classes.
```{r}
...
We specify a probit link function, and vague $N(0, 100^2)$ priors on each parameter.
...
psoriasis_mlnmr <- nma(psoriasis_net, 
                       ...
                       prior_intercept = half_normal(100),
                       prior_trt = half_normal(100),
                       prior_reg = half_normal(100),
