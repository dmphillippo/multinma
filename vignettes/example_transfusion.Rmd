...
summary_mcmc_array(noninf_tausq)
```
...
test_that("Non-informative RE heterogeneity variance", {
  ...
  expect_equal(tr_RE_noninf_var$`2.5%`, 0.003, tolerance = tol)
  expect_equal(tr_RE_noninf_var$`97.5%`, 1.70, tolerance = tol)
})
