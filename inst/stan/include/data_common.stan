...
int<lower=0> CE_vector[class_effects ? (nt-1) : 0]; // ID of class for each arm (0 for no RE delta)
int<lower=0> CEsd_vector[class_effects ? (nt-1) : 0]; // Design vector for class standard deviations
