...
The Stan control argument `adapt_delta` sets the target average
acceptance probability for the No-U-Turn Sampler (NUTS) used by Stan.

## Details

The default value of `adapt_delta` used by
[`nma()`](https://dmphillippo.github.io/multinma/reference/nma.md) is
0.8 for fixed effect models, and 0.95 for random effects models.
