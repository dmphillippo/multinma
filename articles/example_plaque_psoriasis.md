...
#> lp__                                -1570.45  1745    1
#> 
#> Samples were drawn using NUTS(diag_e) at Tue Apr 14 08:30:51 2026.
...
(argument `iter` in
[`nma()`](https://dmphillippo.github.io/multinma/reference/nma.md)) or
to insufficient integration points (`n_int` in
[`add_integration()`](https://dmphillippo.github.io/multinma/reference/add_integration.md)),
...
in [`nma()`](https://dmphillippo.github.io/multinma/reference/nma.md)
and using the
...
[`nma()`](https://dmphillippo.github.io/multinma/reference/nma.md) as
before, except now with `trt_effects = "random"`.
...
#> tau                                     0.46   619 1.01
#> 
#> Samples were drawn using NUTS(diag_e) at Tue Apr 14 08:34:04 2026.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
```
