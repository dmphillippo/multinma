...
The DIC for the random effects model (257.4) is much lower than that of the fixed effects model (328.4) due to the large decrease in residual deviance showing a much better fit to the data. Therefore, our preferred No Class NMA model is the RE model, which we use in subsequent steps.

### STEP 2: Consistency assessment
Next, we assess consistency, comparing model fit statistics for the UME model and the No Class NMA (con-
sistency) model, both with random treatment effects. 
